...
// We want this to be just big enough to start paging to disk without running forever
// Very dependant on CPU memory and what else is running
static const int64 kMAX_MB = 7500;	//  7.5 GB
...
int main (int argc, const char** argv) {
  ...
  int64 chunkcount = (max_mb << 20) / k40_MB;
  ...
  kutrace::stop("ku_hog_scan.trace");
