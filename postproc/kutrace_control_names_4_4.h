...
// dick sites 2016.10.07
// These are from linux-4.4.0 x86 64-bit. Others will vary.
//
...
static const NumNamePair IrqNames[] = {
  ...
  {23, "usb2"},
  {24, "xhci_hcd_usb"},	// usb
  {25, "1f.2_disks"},		// disk(s)
  {26, "i915_graphics"},	// graphics
  {27, "enp2s0_eth0"},	// aka eth0
  {28, "mei_me"},		// Management Engine Interface
  {29, "snd_hda_29"},		// audio?
  {30, "snd_hda_30"},		// audio?

  {0xc1, "disk/ssd"},		// 2016 for our particular machines dclab-1,2,3,4
  {0xd1, "eth0"},
  ...
  {242, "posted_intr"},
  {240, "flush_tlb_ipi"},
  {239, "local_timer_vector"},	// event 0x05ef, decimal 1519
